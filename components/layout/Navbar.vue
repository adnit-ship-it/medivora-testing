...
// Get layout for current route (falls back to common.layout if route doesn't have its own)
const layout = computed(() => siteTextStore.getLayoutForRoute(route.path));
